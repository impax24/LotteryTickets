...
//    Litecoin and modified for LotteryTickets.
//
//    Parameters: lookup (int) - How many blocks to look into the past.
//    Returns: Estimated LotteryTickets network hash rate (uint64_t)
//
...
// WM - Implementation of getnetworkhashps for LotteryTickets
Value getnetworkhashps(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            "getnetworkhashps\n"
            "Returns an estimate of the LotteryTickets network hash rate.");
